...
func TestHookProvider_gatherMetrics_commit_id_before_and_after(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			appSlug: "slug",
			want:    `{"event":"git_push","action":"created","provider_type":"gitlab","repository":"bitrise-io/project","timestamp":"2023-10-26T08:00:00Z","app_slug":"slug","original_trigger":"push:","user_name":"bitrise-bot","git_ref":"dev-1","commit_id_after":"d6666f44e4a5c82c20a783da58c4274a6e3690c3","commit_id_before":"0000000000000000000000000000000000000000","oldest_commit_timestamp":"2023-10-31T09:39:09Z","latest_commit_timestamp":"2023-10-31T09:39:09Z","master_branch":"master","changed_files_count":1,"addition_count":0,"deletion_count":0}`,
		},
	}
